...
struct LogView: View {
    ...
    @AppStorage("logTimeFrame", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")) var logTimeFrame = 2
...
struct LogInsightsView: View {
    ...
    @AppStorage("logInsightsTimeFrame", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")) var timeframe = 2
    @AppStorage("logInsightsType", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")) var insightsType = 1

    @AppStorage("logViewLineGraph", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")) var lineGraph: Bool = false
    ...
    var range: Int {
        ...
        calendar.firstWeekday = UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")?.integer(forKey: "firstWeekday") ?? 0
...
struct TransactionsList: View {
    ...
    @AppStorage("showUpcomingTransactions", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")) var showUpcoming: Bool = true
    @AppStorage("showUpcomingTransactionsWhenUpcoming", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")) var showSoon: Bool = false
...
struct ListView: View {
    ...
    @AppStorage("swapTimeLabel", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")) var swapTimeLabel: Bool = false
...
struct DeleteTransactionAlert: View {
    ...
    @AppStorage("bottomEdge", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")) var bottomEdge: Double = 15
