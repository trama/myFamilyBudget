...
struct SettingsView: View {
  ...
  @AppStorage("colourScheme", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget"))
  ...
  @AppStorage("firstWeekday", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget"))
  ...
  @AppStorage("showNotifications", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget"))
  var showNotifications: Bool = false
  @AppStorage("notificationOption", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget"))
  var option: Int = 1
...
//  }
  ...
  let supportEmail = SupportEmail(toAddress: "fedetx@gmail.com", subject: "Support Email")
  let featureRequestEmail = SupportEmail(
    toAddress: "fedetx@gmail.com", subject: "Feature Request")

  @AppStorage("numberEntryType", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget"))
  ...
  @AppStorage("showCents", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget"))
  var showCents: Bool = true

  @AppStorage("animated", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")) var animated:
    Bool = true
  ...
  @AppStorage(
    "showUpcomingTransactions", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget"))
  ...
  var upcomingString: String {
    ...
    @AppStorage("haptics", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget"))
...
struct TipJarAlert: View {
  ...
  @AppStorage("bottomEdge", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget"))
