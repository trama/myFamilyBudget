...
struct SettingsNotificationsView: View {
  ...
  @AppStorage("notificationsEnabled", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget"))
  ...
  var body: some View {
    VStack {
      ...
      if showNotifications {
        ...
        .onAppear {
          if UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")!.object(
            forKey: "notificationOption") != nil {
            option = UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")!.integer(
              forKey: "notificationOption")
          }

          if UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")!.object(forKey: "customHour")
            != nil
            && UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")!.object(forKey: "customMinute")
              != nil {
            var components = DateComponents()
            components.hour = UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")!.integer(
              forKey: "customHour")
            components.minute = UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")!.integer(
              forKey: "customMinute")
...
func newNotification() {
  ...
  if UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")!.object(forKey: "notificationOption")
    != nil {
    option = UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")!.integer(
      forKey: "notificationOption")
  }
  ...
  if option == 1 {
    ...
    if UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")!.object(forKey: "customHour") != nil,
      UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")!.object(forKey: "customMinute") != nil {
      components.hour = UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")!.integer(
        forKey: "customHour")
      components.minute = UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")!.integer(
        forKey: "customMinute")
