...
struct SettingsGoofyView: View {
  ...
  @AppStorage("confetti", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")) var confetti:
    Bool = false

  //    @AppStorage("chromatic", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")) var chromatic: Bool = false

  @AppStorage("logViewLineGraph", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget"))
  var lineGraph: Bool = false

  @AppStorage("budgetViewStyle", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget"))
  var budgetRows: Bool = false

  @AppStorage("swapTimeLabel", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget"))
  var swapTimeLabel: Bool = false

  @AppStorage(
    "showTransactionRecommendations", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget"))
