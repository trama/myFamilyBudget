...
struct ActualBudgetView: View {
    ...
    @AppStorage("budgetViewStyle", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")) var budgetRows: Bool = false
