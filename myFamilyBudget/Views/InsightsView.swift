...
struct InsightsView: View {
    ...
    @AppStorage("chartTimeFrame", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")) var chartType = 1
...
struct HorizontalPieChartView: View {
    ...
    init(date: Date, categoryFilter: Binding<Category?>?, categoryFilterMode: Binding<Bool>, selectedDate: Binding<Date?>?, chosenAmount: Binding<Double>, chosenName: Binding<String>, type: ChartTimeFrame, income: Bool) {
        ...
        calendar.firstWeekday = UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")!.integer(forKey: "firstWeekday")
...
//        return abs(offset) > UIScreen.main.bounds.width * 0.3
    ...
    @AppStorage("insightsViewIncomeFiltering", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")) var income: Bool = true
    @AppStorage("incomeTracking", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")) var incomeTracking: Bool = true
...
//    @AppStorage("animated", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")) var animated: Bool = true
