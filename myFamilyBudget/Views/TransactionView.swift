...
struct TransactionView: View {
    ...
    @AppStorage("topEdge", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")) var topEdge:
    Double = 20
    ...
    @AppStorage(
        "firstTransactionViewLaunch", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget"))
