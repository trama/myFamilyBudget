...
struct TemplateTransactionView: View {
    ...
    @AppStorage("numberEntryType", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")) var numberEntryType: Int = 1

    @Environment(\.colorScheme) var colorScheme

    @AppStorage("topEdge", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")) var topEdge: Double = 30
    ...
    @AppStorage("firstTransactionViewLaunch", store: UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")) var firstLaunch: Bool = true
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: -2) {
            ...
            HStack(alignment: .lastTextBaseline, spacing: 1.3) {
                Text(currencySymbol)
                    .font(.system(size: downsize.small, weight: .medium))
                    .foregroundColor(Color.PrimaryText)
                    .baselineOffset(getDollarOffset(big: downsize.big, small: downsize.small))
