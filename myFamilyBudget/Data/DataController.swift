...
//        }
        ...
        //description.ContainerOptions = NSPersistentContainerOptions(containerIdentifier: "iCloud.com.rafaelsoh.dime")

        let groupID = "group.com.fedetx.myFamilyBudget"
...
////        }
    ...
    var addedTransaction: Bool {
        get {
            UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")!.bool(forKey: "newTransactionAdded")
        }

        set {
            UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")!.set(newValue, forKey: "newTransactionAdded")
        }
    }
    ...
    func fetchRequestForLogView(type: Int, optionalIncome: Bool?, categoryFilters: [Category] = []) -> NSFetchRequest<Transaction> {
        ...
        if type == 5 {
            ...
            if type == 1 {
                ...
                let startOfMonth = UserDefaults(suiteName: "group.com.fedetx.myFamilyBudget")!.integer(forKey: "firstDayOfMonth")
